...
// {
// 	get_textures(game);
// 	game->img.NO = mlx_texture_to_image(game->mlx_ptr,
// 			game->tex.NO);
// 	game->img.SO = mlx_texture_to_image(game->mlx_ptr,
// 			game->tex.SO);
// 	game->img.WE = mlx_texture_to_image(game->mlx_ptr,
// 			game->tex.WE);
// 	game->img.EA = mlx_texture_to_image(game->mlx_ptr,
// 			game->tex.EA);
// 	clean_texture(game);
// }
